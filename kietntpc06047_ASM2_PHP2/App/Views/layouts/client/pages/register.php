            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="mb-3">
                    <label for="loginInputEmail1" class="form-label">Họ và tên </label>
                    <input name="name" type="name" class="form-control" id="loginInputEmail1" aria-describedby="nameHelp">
                    
                </div>
                <div class="mb-3">
                    <label for="loginInputEmail1" class="form-label">Email </label>
                    <input name="email" type="email" class="form-control" id="loginInputEmail1" aria-describedby="emailHelp">
                    
                </div>
                <div class="mb-3">
                    <label for="loginInputPassword1" class="form-label">Mật Khẩu</label>
                    <input name="password" type="password" class="form-control" id="loginInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="loginInputPassword1" class="form-label"> Nhập lại mật Khẩu</label>
                    <input name="password" type="password" class="form-control" id="loginInputPassword1">
                </div>
                      
                <button type="submit" name="submit" class="btn btn-primary">Đăng ký</button>
                        <p class="text-center mb-0">Bạn có sẵn một tài khoản? <a href="?url=LoginController/loadViewLogin">Đăng nhập</a></p>
                       </form>
                    </div>
                </div>
            </div>
