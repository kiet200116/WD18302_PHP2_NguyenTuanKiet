            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" action="?url=QuenMk/handleLogin" class="d-flex justify-content-center flex-column">
                <div class="mb-3">
                ...
                <div class="mb-3 form-check">
                    ...
                    <label class="form-check-label" for="loginCheck1" ><a href='?url=LoginController/loadViewLogin'>Quay lại trang đăng nhập</a></label>
                </div>
