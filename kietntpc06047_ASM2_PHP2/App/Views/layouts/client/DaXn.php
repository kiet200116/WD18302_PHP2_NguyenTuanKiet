 <!-- Content Start -->
 <div class="content">
 <a href="?url=DaXn/loadViewDaXn" ></a>
            <!-- Navbar Start -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Danh sách dự án xây nhà</h6>
                        <a href="">Xem tất cả</a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <td>1</td>
                                    ...
                                    <td>Võ Duy Phương</td>
                                    <td>hiện</td>
                                    <td><a class="btn btn-sm btn-primary" href="">Ẩn</a>
                                    <a class="btn btn-sm btn-primary" href="">hiện</a></td>
                                </tr>
                                <tr>
